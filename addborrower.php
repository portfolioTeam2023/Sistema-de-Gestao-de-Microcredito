...
?>
  <?php 
   ...
   ?>
        <h3 class="page-heading mb-4">Adicionar Cliente</h3>
        <h5 class="card-title p-3 bg-info text-white rounded">Dados pessoais do Cliente</h5>
        <div class="container">
          <?php
          if (isset($inserted)){
          ?>
          ...
          <form action="" method="post" enctype="multipart/form-data" id="add_borrower_form">
            ...
            <div class="form-group row">
              <label for="inputBorrowerFirstName" class="text-right col-2 font-weight-bold col-form-label">Nome Completo</label>                      
              <div class="col-sm-9">
            ...
            <div class="form-group row">
              <label for="inputBorrowerUniqueNumber" class="text-right col-2 font-weight-bold col-form-label">Numero de BI</label>                      
              <div class="col-sm-9">
                  <input type="text" name="borrower_nid" class="form-control" id="inputBorrowerUniqueNumber" placeholder="Unique Number" value="">
                  <p class="text-muted">Deve ser um numero unico </p>
              </div>
            </div>
            <div class="form-group row">
                <label for="inputBorrowerGender" class="text-right col-2 font-weight-bold col-form-label">Genero</label>                      
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <label for="inputBorrowerMobile" class="text-right col-2 font-weight-bold col-form-label">Celular</label>  
                <div class="col-sm-9">
